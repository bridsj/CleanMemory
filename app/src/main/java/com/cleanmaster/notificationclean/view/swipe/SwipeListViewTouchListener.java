...
public class SwipeListViewTouchListener implements View.OnTouchListener {
        ...
        ViewPropertyAnimator viewPropertyAnimator = animate(view);
                ...
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (swap) {
                            performDismiss(isManual, view, position);
                        }
                    }
                });
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                generateAnimate(frontView, true, swap, swapRight, downPosition);
     ...
     */
    private void performDismiss(final boolean isManual, final View dismissView, final int dismissPosition) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (dismissAnimationRefCount == 0) {
                    ...
                    swipeListView.onDismiss(isManual, dismissPositions);
